...
if ($error != "") {
	echo $error;
	echo "<meta http-equiv='refresh' content='2; url=?hal=pegawai_edit&id=$_POST[id]'>"; //redirect pegawai_tambah
} elseif ($query) {
	echo "Data Berahasil disimpan!";
	echo "<meta http-equiv='refresh' content='2; url=?hal=pegawai'>"; //redirect to pegawai
} else {
